...
```
!pip install markdownify duckduckgo-search schema_agents --upgrade -q
```
...
वेब ब्राउज़िंग के लिए, हम पहले से मौजूद [`DuckDuckGoSearchTool`](https://github.com/huggingface/schema_agents/blob/main/src/schema_agents/default_tools.py#L151-L176) टूल का उपयोग कर सकते हैं जो Google search के समान सुविधा प्रदान करता है।
