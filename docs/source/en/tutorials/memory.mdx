...
```py
from schema_agents import HfApiModel, CodeAgent
...
```py
from schema_agents import ActionStep
...
_Note: this code is incomplete, some imports and object definitions have been removed for the sake of concision, visit [the original script](https://github.com/huggingface/schema_agents/blob/main/src/schema_agents/vision_web_browser.py) to get the full working code._
...
Head to our [vision web browser code](https://github.com/huggingface/schema_agents/blob/main/src/schema_agents/vision_web_browser.py) to see the full working example.
...
```py
from schema_agents import HfApiModel, CodeAgent, ActionStep, TaskStep
