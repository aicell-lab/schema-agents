...
> [!TIP]
> If you're new to building agents, make sure to first read the [intro to agents](../conceptual_guides/intro_agents) and the [guided tour of schema_agents](../guided_tour).
...
<div class="flex justify-center">
    <img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/schema_agents/inspect_run_phoenix.gif"/>
</div>
...
```shell
pip install 'schema_agents[telemetry]'
```
...
<img src="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/schema_agents/inspect_run_phoenix.png">
...
This part shows how to monitor and debug your Hugging Face **schema_agents** with **Langfuse** using the `SmolagentsInstrumentor`.
...
%pip install opentelemetry-sdk opentelemetry-exporter-otlp openinference-instrumentation-schema_agents
```
...
manager_agent.run(
    "How can Langfuse be used to monitor and improve the reasoning and decision-making of schema_agents when they execute multi-step tasks, like dynamically adjusting a recipe based on user feedback or available ingredients?"
)
```

### Step 5: View Traces in Langfuse

After running the agent, you can view the traces generated by your schema_agents application in [Langfuse](https://cloud.langfuse.com). You should see detailed steps of the LLM interactions, which can help you debug and optimize your AI agent.

![schema_agents example trace](https://langfuse.com/images/cookbook/integration-schema_agents/smolagent_example_trace.png)
