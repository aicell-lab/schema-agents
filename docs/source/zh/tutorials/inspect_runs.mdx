...
> [!TIP]
> 如果您是初次构建Agent，建议先阅读 [Agent 入门指南](../conceptual_guides/intro_agents) 和 [schema_agents 导览](../guided_tour)。
...
本部分演示如何通过 `SmolagentsInstrumentor` 使用 **Langfuse** 监控和调试 Hugging Face **schema_agents**。
...
运行Agent后，您可以在 [Langfuse](https://cloud.langfuse.com) 平台查看 schema_agents 应用生成的追踪记录。这些记录会详细展示LLM的交互步骤，帮助您调试和优化AI代理。

![schema_agents 追踪示例](https://langfuse.com/images/cookbook/integration-schema_agents/smolagent_example_trace.png)
