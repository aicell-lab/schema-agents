...
"""
    ...
    def install_packages(self, additional_imports: List[str]):
        additional_imports = additional_imports + ["schema_agents"]
    ...
    def __init__(self, additional_imports: List[str], logger):
        ...
        try:
            ...
            raise ModuleNotFoundError(
                """Please install 'e2b' extra to use E2BExecutor: `pip install 'schema_agents[e2b]'`"""
            )
...
class DockerExecutor(RemotePythonExecutor):
    ...
    def __init__(
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'docker' extra to use DockerExecutor: `pip install 'schema_agents[docker]'`"
            )
        self.host = host
        self.port = port
