...
class MLXModel(Model):
    ...
    > [!TIP]
    > You must have `mlx-lm` installed on your machine. Please run `pip install schema-agents[mlx-lm]` if it's not the case.
        ...
        **kwargs,
        ...
        if not _is_package_available("mlx_lm"):
            raise ModuleNotFoundError(
                "Please install 'mlx-lm' extra to use 'MLXModel': `pip install 'schema-agents[mlx-lm]'`"
            )
        import mlx_lm
...
class TransformersModel(Model):
    ...
    > [!TIP]
    > You must have `transformers` and `torch` installed on your machine. Please run `pip install schema-agents[transformers]` if it's not the case.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not is_torch_available() or not _is_package_available("transformers"):
            raise ModuleNotFoundError(
                "Please install 'transformers' extra to use 'TransformersModel': `pip install 'schema-agents[transformers]'`"
            )
        import torch
...
class LiteLLMModel(Model):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_id = model_id
        # Import litellm here to ensure it's available when needed
        import litellm
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise ModuleNotFoundError(
                "Please install 'openai' extra to use OpenAIServerModel: `pip install 'schema_agents[openai]'`"
            ) from None
