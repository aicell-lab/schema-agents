...
from schema_agents.agents import ActionStep
...
def parse_arguments():
    ...
    parser.add_argument(
        "--eval-dataset",
        type=str,
        default="schema_agents/benchmark-v1",
    )
    # The eval dataset is gated, so you must first visit its page to request access: https://huggingface.co/datasets/schema_agents-benchmark/benchmark-v1
    parser.add_argument(
        "--model-type",
        type=str,
        default="HfApiModel",
