...
from schema_agents.teams.geo_explorer_hub import create_geo_explorer_hub
import logging
...
async def chat(msg, client, context=None):
    ...
    hub = create_geo_explorer_hub(client = client, investment = 0.5, path_to_json = "/Users/gkreder/org/data/23/11285E-44E6-41D2-A329-313BB96536D6/GEO_search_terms.json")
