...
from schema_agents.default_tools import DuckDuckGoSearchTool, GoogleSearchTool, SpeechToTextTool, VisitWebpageTool
from schema_agents.tool_validation import validate_tool_attributes
...
@pytest.mark.asyncio
async def test_validate_tool_attributes_with_default_tools(tool_class):
    """Test that default tools pass validation."""
